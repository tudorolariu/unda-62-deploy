  ...
  return (
    <div>
      ...
      <div className=" bg-white">
        <div
          className="flex flex-col w-full-2xl h-auto p-14 max-md:px-4 items-center
        font-body font-medium scrollbar-thumb-cyan scrollbar-track-cyan-dark"
        >
          {/* Logo */}
          <a
            href="https://unda62.com/"
            id="homeButton"
            className="flex w-fit p-3 bg-cyan-dark items-center cursor-pointer hover:text-yellow mb-14 rounded-xl"
          >
            <div id="navbarLogo">
              <Image alt="logo" src={logo} className="w-16 rounded-full" />
            </div>
            <p className="px-3 font-semibold text-xl lg:text-lg">
              Pagină principală
            </p>
          </a>
