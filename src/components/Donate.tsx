...
import doneazaWEBP from "@/assets/doneaza.webp";
      ...
      <div className="flex flex-col w-full-2xl h-auto pt-14 lg:pt-20 max-md:px-4 items-center">
        <div className="md:w-11/12 flex flex-col md:flex-row justify-between items-start gap-12 max-md:gap-6">
          ...
          <motion.div
            ...
            whileInView={"shown"}
            viewport={{ once: true, amount: 0.25 }}
            className="max-md:hidden w-full flex flex-col md:w-3/5"
          >
            ...
            <p className="w-full text-md text-black text-justify">
              ...
              este un loc unde ideile prind viață, comunitatea se dezvoltă, iar
              tinerii găsesc sprijinul de care au nevoie pentru a-și îndeplini
              visurile.{" "}
              <b>
                Prin donații și sponsorizări, contribui direct la sprijinirea
                visurilor lor și la construirea unei comunități mai echitabile,
                unde fiecare tânăr are șansa să învețe, să socializeze și să
                aparțină unui mediu suportiv.
              </b>
            </p>
            ...
            <p className="w-full text-md text-black text-justify">
              Poți redirecționa 3,5% din impozitul pe venit către UNDA 62. Este
              o contribuție simplă, dar cu un impact major în derularea
            ...
            <p className="w-full text-md text-black text-justify">
              Sprijinul tău poate ajunge rapid și sigur la noi printr-o donație
              online. Fiecare sumă contează și contribuie la proiectele noastre
              educaționale și comunitare.
            </p>

            <div className="flex gap-1 mt-2 text-md text-black font-bold items-start">
              <span>3.</span>
              <p className="w-full text-justify">Donează produse și servicii</p>
            </div>

            <p className="w-full text-md text-black text-justify">
              Ai posibilitatea de a contribui cu produse sau servicii esențiale
              pentru activitățile noastre. ➡️ Răsfoiește{" "}
              <a
            ...
            <p className="w-full text-md text-black text-justify">
              Compania ta poate redirecționa până la 20% din impozitul pe profit
              pentru a susține proiectele UNDA 62. Descoperă contractele de
              sponsorizare disponibile și alege tipul care ți se potrivește:
              directă, retroactivă sau în produse.
            </p>
          ...
          <motion.div
            ...
            className="md:hidden w-full flex flex-col md:w-3/5"
          >
            <h2 className="max-md:hidden text-4xl max-md:text-3xl text-black font-semibold mb-8 max-md:mb-4">
              Donează
            </h2>
